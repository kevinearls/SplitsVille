...
// swiftlint:disable line_length
  ...
  /*
  - Friends: Me, Martha, Amy, Nancy, Patrick, Mike, Jo-Ann, Michelle, Paul
  - Trips: 
    - Paris - Patrick's French Adventure (Patrick, Kevin, Martha); Dates: 21/4/24 - 27/4/24
      - RER B 27,90
      - Sainte-Chapelle 26,00
      - Arc de Triomphe 18,00
      - Taxi 62
      - Five Guys 4612
      - Novotel: 278,73
      - Dinner: 167,75
    - Ireland - Visiting Family (Kevin, Mike, Martha, Jo-Ann, Patrick, James) ;  23/8 - 30/8
      - 
    - Portugal - Street Art and Wine (Kevin, Martha, Amy, Nancy) Dates: 27/2 - 4/3/24
   */
